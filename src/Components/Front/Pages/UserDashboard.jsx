    ...
    return (
      <>
          ...
          <div className='bg-darkBlack h-[1000px] md:h-[800px] w-[100%]'>
            ...
            <h3 className='pt-5 text-[24px] font-Encode text-white'>Welcome, Investor Starks</h3>
            ...
            <h3 className='text-[18px] md-[text-20px]'>This is a Level 1 account</h3>
            ...
            <div className='flex flex-col md:flex-row mt-20 w-[100%] gap-8'>
              <div className='bg-gray-300 rounded-md w-[100%] md:w-[45%] '>
                ...
                <div className='py-5'>
                <p className='text-[18px] font-Encode font-semibold pl-5'>$25,000</p>
                </div>
              </div>
              ...
              <div className='bg-gray-300 rounded-md w-[100%] md:w-[45%] '>
                ...
                <Percent size={32} />
                <p className='text-[20px]'>Promotional Balance</p>
                </div>
                <div className='py-5'>
                <p className='text-[18px] font-Encode font-semibold pl-5'>$3,000</p>
                </div>
              </div>
            </div>
            <FinlogixTape />
