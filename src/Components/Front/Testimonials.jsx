  ...
  return (
    <div className='px-10 md:px-20 mt-20 bg-darkBlack h-[800px] md:h-[600px] w-[100%]'>
        ...
        <div className='card bg-white flex flex-col justify-center items-center px-1 md:px-10 py-5 rounded-md'>
            ...
            <p className='pt-5 text-center mb-5 font-Encode'>I think the platform is really easy to use, it has helped me create a staedy income for myself, thanks to my agent also. but i think the platform also need to hasten up on withdrawls, my last withdrawals took me about 7-8 hours before i recieved it.</p>
        </div>
        ...
        <div className='card bg-white flex flex-col justify-center items-center px-1 md:px-10 py-5 rounded-md'>
            ...
            <p className='pt-5 text-center mb-5 font-Encode'>This is a really Great platform, and its easy to use but you should not take up to 24 hours to deposit my profits, you guys need to work on your timing please. thank you for everything tho. *smiles*</p>
        </div>
        ...
        <div className='card bg-white flex flex-col justify-center items-center px-1 md:px-10 py-5 rounded-md'>
            ...
            <p className='pt-5 text-center mb-5 font-Encode'>For a well secured , well managed, and good customer relation. Global Tradez is the best plug for that. I just cleared my Debts thank you global tradez.</p>
        </div>
        ...
        <div className='card bg-white flex flex-col justify-center items-center px-1 md:px-10 py-5 rounded-md'>
            ...
            <p className='pt-5 text-center mb-5 font-Encode'>I'm an international student in canada and i just paid my school fees thanks to you guys. im going to get me a dodge soon</p>
        </div>
        ...
        <div className='card bg-white flex flex-col justify-center items-center px-1 md:px-10 py-5 rounded-md'>
            ...
            <p className='pt-5 text-center mb-5 font-Encode'>As an international client, i appreciate global tradez commitment to understanding local markets and tailoring solutions to my needs.</p>
        </div>
        ...
        <div className='card bg-white flex flex-col justify-center items-center px-1 md:px-10 py-5 rounded-md'>
            ...
            <p className='pt-5 text-center mb-5 font-Encode'>global tradez hands-on approach has helped me navigate market fluctuations and stay on track towards my financial targets</p>
        </div>
