...
const Entitled = () => {
  return (
    <div className='Container h-[900px] md:h-[700px] w-100%'>
        ...
        <div className='wrapper bg-darkBlack text-white h-[900px] md:h-[700px] mt-0 mb-0 pt-20 px-5 md:px-10 lg:px-20'>
            <div className='Entitle1 flex flex-col md:flex-row'>
                <div className='texts w-[100%] md:w-[60%]'>
                ...
                <div className='animation pt-[90px] md:pt-0 w-[100%] md:w-[40%]'>
